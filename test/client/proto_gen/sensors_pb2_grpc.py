...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in proto_gen/sensors_pb2_grpc.py depends on'
...
def add_SensorServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'sensors.SensorService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('sensors.SensorService', rpc_method_handlers)
